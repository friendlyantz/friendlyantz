...
* [ ] If you don't use iso and use Images( Ubuntu was 500Mb for IMG vs 2Gb+ for ISO) - wget image via Proxmox Shell an `img`. i.e [Ubuntu 24](https://cloud-images.ubuntu.com/noble/current/)
```sh
...
- [ ] in Hardware tab of VM: UnusedDisk -> edit: 
	- [ ] check Discard if it is SSD
	- [ ] check Enable SSD emulation
- [ ] Options tab: BootOrder - enable and move to 2nd position after CD drive
