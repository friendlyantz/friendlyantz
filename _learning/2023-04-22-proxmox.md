...
### opt1 - on top of LXC container install
1. install LXC container on Proxmox -see above
2. install [docker](https://docs.photoprism.app/getting-started/troubleshooting/docker/#installation), easiest way below:
```sh
